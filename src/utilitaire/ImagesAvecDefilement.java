 ...
 * derriere le texte (setBackground) - la largeur de ce cadre en pixels
 * (setLargeurCadre)
 * 
 * @author Caroline Houle
 * @author Antonin Tritz (Implémentation)
 */
...
public class ImagesAvecDefilement extends JPanel {
	...
	private int largeurCadre = 6; // nombre de pixels laisses vides autour du scrollpane (prendra la couleur du
	// fond du jpanel)
	...
	/**
	 * Cree un composant destiné a contenir une serie de pages (images) S,Il n'y a
